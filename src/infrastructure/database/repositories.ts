...
import { PrismaFolderRepository } from "@/modules/folders/infrastructure/prisma-folder.repository";
...
export function getFolderRepository(): IFolderRepository {
  return new PrismaFolderRepository(prisma);
}
